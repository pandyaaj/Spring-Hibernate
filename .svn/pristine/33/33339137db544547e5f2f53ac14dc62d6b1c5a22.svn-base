...
public class UserController {
    ...
    @RequestMapping("admin/adminView.html")
    ...
    @RequestMapping("reviewer/reviewerView.html")
    ...
    public String reviewer(ModelMap models)
    {
    	...
    	models.put( "job", jobDao.getJobs());
    	
        return "reviewer";
    }

    @RequestMapping("/applicant.html")
    public String applicant(  ModelMap models , Authentication authentication)
    {
    ...
    //	User authenticatedUser = (User) authentication.getPrincipal();
        ...
        User user = userDao.getUser( ((User) authentication.getPrincipal()).getId() );
    ...
    @RequestMapping(value = "/admin/formcommity.html",
            method = RequestMethod.GET)
        public String formcommity( @RequestParam Long jobid, ModelMap models )
        {
    		return null;    		
        }
        ...
        public String formcommity( @ModelAttribute Application application,
